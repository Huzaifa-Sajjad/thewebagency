...
function Footer() {
  return (
    <section className="xs:py-14 lg:py-20 bg-primary">
      <div className="lg:container mx-auto">
        <div className="grid grid-cols-12 gap-y-7">
          <div className="xs:col-span-12 lg:col-span-6">
            <div className="flex items-center xs:justify-center lg:justify-start">
              <img className="h-10 w-auto mr-4" src="/logo.png" alt="" />
              <h3 className="text-22 text-white">The Web Agency</h3>
            </div>
          </div>
          <div className="xs:col-span-12 lg:col-span-6">
        ...
        <div className="grid grid-cols-12 gap-y-7 mt-12">
          <div className="xs:col-span-12 lg:col-span-6">
            <div className="flex flex-wrap items-center xs:justify-center lg:justify-start">
              <Link href="/">
                <span className="text-white text-18 xs:mr-4 lg:mr-10">
                  Home
                </span>
              </Link>
              <Link href="/about">
          ...
          <div className="xs:col-span-12 lg:col-span-6">
            <div className="flex flex-wrap items-center xs:justify-center lg:justify-end">
              <span className="text-white text-18 mr-2">
                &copy; TWA. All Rights Reserved
              </span>
			...
			s85.333,38.281,85.333,85.333C341.333,217.719,303.052,256,256,256z"
                ...
                <span className="text-white text-18">Hesse, Germany</span>
              </div>
            </div>
          </div>
        </div>
