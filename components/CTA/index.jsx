...
function CTA() {
  ...
  return (
    <section className="my-20">
      <div className="lg:container mx-auto py-14 text-center">
        ...
        <button
          ...
          className="xs:text-16 md:text-16 lg:text-20 xl:text-22 bg-primary border-2 border-black text-white w-max px-14 py-4 cursor-none"
        >
          Contact Us
        </button>
      </div>
