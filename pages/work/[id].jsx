    ...
    <Layout isFooter={true}>
      <section>
        <div className="lg:container lg:mx-auto">
          <div id="hero" className="flex flex-col justify-center pt-20 mb-28">
            ...
            <p className="xs:text-base md:text-2xl font-light text-gray md:max-w-45 xs:my-6 md:my-6 border-l-4 pl-4">
      ...
      <section>
        <div className="lg:container lg:mx-auto pt-28">
          ...
          <h2 className="text-52 font-semibold">Logotype: A single image</h2>
          <p className="text-28 font-light mt-4 max-w-45 mb-10">
